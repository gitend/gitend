...
| `dsh-resource://chat/session/c1?parent=p1&mode=continuable` | `chat` | an addressed subagent Conversation whose value owns a `SessionReference` until the resource closes |
