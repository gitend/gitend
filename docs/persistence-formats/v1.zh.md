---
description: "完整的 Session V1 持久化类型、来源证据与物理编码参考。"
...
查阅 V2 写入器变更之前的 V1 持久化类型。V1 使用 V0 的物理行布局，保留顶层 Assistant chunk，并将逻辑 header 版本声明为字面量 1。已收录的 alpha/RC 发布归档没有使用该中间格式的 tag。
...
来源为 `dsh-v0.1.3-alpha.1` 祖先历史中首次 V2 写入器变更之前的最后一个 V1 源码树，属于 PR #3349。其源码变更日期为 2026-09-02，标题为 `fix(session): close live assistant framing races`。这标识中间源码树，而非 PR 最终合并的源码树。[预发布归档](../persistence-changes/releases/README.zh.md)没有 V1 tag，本记录不会为此虚构产品发布。
...
- `SessionHeader.version` 解析为字面量 1；物理 `JsonlHeaderLine.version` 仍为 `number`。
- 逻辑 header 要求 `isSeeded`，物理 header 仍使用可选的 `seedLength`。重建历史 header 时必须保留这一区别。
- `assistant/chunk` 仍为顶层事件。`assistant/message` 没有内嵌的 `stream`，且不存在 V2 的 `assistant/attempt` 事件。

[V0/V1 codec](../../packages/session/session-format-v0-to-v1/src/codec.ts)负责共享物理布局，包括打包的 chunk 与数值继承切点。[V1 到 V2 迁移参考](../../packages/session/session-format-v1-to-v2/README.zh.md)负责 chunk 消耗、内嵌流与序号重映射；这些转换不能从类型摘要中推断。
...
[完整机器目录](v1.schema.json)包含 54 个根类型和 415 种可达类型。摘要包含所有引用字段；源码名称和位置描述所选的历史源码树。
...
来源：`packages/core/session/src/types.ts:433`
...
来源：`packages/core/session/src/types.ts:180` · `packages/interaction/commands/src/types.ts:67` · `packages/interaction/commands/src/types.ts:71` · `packages/llm/llm/src/message.ts:103` · `packages/session/session-title/src/types.ts:35`
...
来源：`packages/core/session/src/types.ts:204` · `packages/llm/llm/src/types.ts:119`
...
来源：`packages/core/session/src/types.ts:298`
...
来源：`packages/core/session/src/types.ts:327`
...
来源：`packages/core/session/src/types.ts:275` · `packages/core/session/src/types.ts:277`
...
来源：`packages/core/session/src/types.ts:304`
...
来源：`packages/core/session/src/types.ts:316`
...
来源：`packages/core/session/src/types.ts:320`
...
来源：`packages/core/session/src/types.ts:273`
...
来源：`packages/core/session/src/types.ts:192`
...
来源：`packages/core/session/src/types.ts:181`
...
来源：`packages/core/session/src/types.ts:182`
...
来源：`packages/core/session/src/types.ts:186`
...
来源：`packages/core/session/src/types.ts:202`
...
来源：`packages/core/session/src/types.ts:209`
...
来源：`packages/core/session/src/types.ts:264`
...
来源：`packages/core/session/src/types.ts:220`
...
来源：`packages/core/session/src/types.ts:232`
...
来源：`packages/core/session/src/types.ts:249`
...
来源：`packages/core/session/src/types.ts:91`
...
来源：`packages/core/session/src/types.ts:213`
...
来源：`packages/session/session-persistence-jsonl/src/format.ts:82`
...
来源：`packages/core/session/src/types.ts:402`
...
来源：`packages/api/session-controller/src/types.ts:362` · `packages/attachment/attachment/src/brand.ts:6` · `packages/compaction/compaction/src/brand.ts:4` · `packages/core/session/src/types.ts:17` · `packages/experimental/agent-team/src/types.ts:20` · `packages/experimental/agent-team/src/types.ts:32` · `packages/experimental/agent-team/src/types.ts:8` · `packages/goal/goal/src/types.ts:16` · `packages/interaction/commands/src/brand.ts:20` · `packages/interaction/user-approval/src/types.ts:17` · `packages/llm/llm-retry/src/brand.ts:4` · `packages/llm/llm/src/brand.ts:16` · `packages/llm/llm/src/brand.ts:31` · `packages/llm/llm/src/brand.ts:43` · `packages/llm/llm/src/brand.ts:67` · `packages/schedule/schedule/src/types.ts:10` · `packages/session/session-title/src/index.ts:42` · `packages/session/session-title/src/types.ts:17` · `packages/webhook/webhook/src/brand.ts:12` · `packages/webhook/webhook/src/brand.ts:6` · `packages/webhook/webhook/src/brand.ts:9` · `packages/workflow/workflow/src/types.ts:13`
...
仅使用源码的提取器以 TypeScript 6.0.3 运行。重建时省略冗余的 `object` 交叉类型成员，并丢弃规范化后不可达的类型定义；保留已有的 `any` / `unknown`，不以不透明类型替代未解析的导入。
