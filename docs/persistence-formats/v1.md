...
The source is the last V1 tree before the first V2 writer change in the ancestry of `dsh-v0.1.3-alpha.1`, from PR #3349. Its source change is dated 2026-09-02 and titled `fix(session): close live assistant framing races`. This identifies the intermediate tree, not the final merged PR tree. The [prerelease archive](../persistence-changes/releases/README.md) records no V1 tag, so no product release is invented for this record.
...
The [complete machine inventory](v1.schema.json) contains 54 roots and 415 reachable types. Digests include all referenced fields; source names and locations describe the selected historical tree.
...
Sources: `packages/core/session/src/types.ts:433`
...
Sources: `packages/core/session/src/types.ts:180` · `packages/interaction/commands/src/types.ts:67` · `packages/interaction/commands/src/types.ts:71` · `packages/llm/llm/src/message.ts:103` · `packages/session/session-title/src/types.ts:35`
...
Sources: `packages/core/session/src/types.ts:287`
...
Sources: `packages/core/session/src/types.ts:204` · `packages/llm/llm/src/types.ts:119`
...
Sources: `packages/core/session/src/types.ts:298`
...
Sources: `packages/core/session/src/types.ts:327`
...
Sources: `packages/core/session/src/types.ts:275` · `packages/core/session/src/types.ts:277`
...
Sources: `packages/core/session/src/types.ts:304`
...
Sources: `packages/core/session/src/types.ts:316`
...
Sources: `packages/core/session/src/types.ts:320`
...
Sources: `packages/core/session/src/types.ts:192`
...
Sources: `packages/core/session/src/types.ts:181`
...
Sources: `packages/core/session/src/types.ts:182`
...
Sources: `packages/core/session/src/types.ts:186`
...
Sources: `packages/core/session/src/types.ts:202`
...
Sources: `packages/core/session/src/types.ts:220`
...
Sources: `packages/core/session/src/types.ts:232`
...
Sources: `packages/core/session/src/types.ts:249`
...
Sources: `packages/core/session/src/types.ts:213`
...
Sources: `packages/session/session-persistence-jsonl/src/format.ts:82`
...
Sources: `packages/core/session/src/types.ts:402`
...
Sources: `packages/api/session-controller/src/types.ts:362` · `packages/attachment/attachment/src/brand.ts:6` · `packages/compaction/compaction/src/brand.ts:4` · `packages/core/session/src/types.ts:17` · `packages/experimental/agent-team/src/types.ts:20` · `packages/experimental/agent-team/src/types.ts:32` · `packages/experimental/agent-team/src/types.ts:8` · `packages/goal/goal/src/types.ts:16` · `packages/interaction/commands/src/brand.ts:20` · `packages/interaction/user-approval/src/types.ts:17` · `packages/llm/llm-retry/src/brand.ts:4` · `packages/llm/llm/src/brand.ts:16` · `packages/llm/llm/src/brand.ts:31` · `packages/llm/llm/src/brand.ts:43` · `packages/llm/llm/src/brand.ts:67` · `packages/schedule/schedule/src/types.ts:10` · `packages/session/session-title/src/index.ts:42` · `packages/session/session-title/src/types.ts:17` · `packages/webhook/webhook/src/brand.ts:12` · `packages/webhook/webhook/src/brand.ts:6` · `packages/webhook/webhook/src/brand.ts:9` · `packages/workflow/workflow/src/types.ts:13`
...
The source-only extractor ran with TypeScript 6.0.3. Reconstruction omits redundant `object` intersection members and discards normalization-unreachable type definitions; it preserves existing `any` / `unknown` and does not substitute opaque types for unresolved imports.
