...
The [complete machine inventory](v0.schema.json) contains 54 roots and 415 reachable types. Digests include all referenced fields; source names and paths describe the selected historical tree.
