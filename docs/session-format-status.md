...
The [format references](persistence-formats/README.md) document every integer from zero through the checkout writer, with historical schemas and the existing current catalog.
