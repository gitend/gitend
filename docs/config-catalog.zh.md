...
来源：[`packages/interaction/permission-presets/src/index.ts:157`](../packages/interaction/permission-presets/src/index.ts)
...
- `@deepseek-ai/dsh-auto-review` — 需要 `llm` · `permissionPresets` · `sessions` · `tools`（[`packages/interaction/auto-review/src/index.ts`](../packages/interaction/auto-review/src/index.ts)）
