...
One inbox feeds the driver. Some messages wake it immediately; injected context waits for another message. AgentLoop owns the durable `inbox` projection, making pending input readable without live Agents.
