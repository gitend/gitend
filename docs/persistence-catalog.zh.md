...
[机器可读目录](persistence-schema.json)包含所有可达的规范化类型及其 SHA-256 摘要。根类型的摘要涵盖引用类型。注释、源码位置、别名、擦除的品牌标记、readonly 标记和对象属性声明顺序不影响摘要；元组顺序、属性名称、值类型和可选性会影响摘要。
...
| `event:assistant/message` | event | `a58ca1bed502d425a8b65cac02f59717498cd296de9513c6f81b83b791c20e9b` | [`event:assistant/message`](#persistence-type-eventassistantmessage) |
...
| `event:system/message` | event | `0ae7ccdc1cc5d9d43772ebd5c7357ff509011c3a6ba188d9c274d33df2542c42` | [`event:system/message`](#persistence-type-eventsystemmessage) |
...
<a id="persistence-type-eventagent-presetselectedtype"></a>

### `event:agent-preset/selected.type`

SHA-256: `557e148d30b79ee48645850832b30c717d7c3b64641deb5d6133b8b4e91ee0b8`

来源：[`packages/core/session/src/types.ts:467`](../packages/core/session/src/types.ts)
...
来源：[`packages/core/agent/src/types.ts:91`](../packages/core/agent/src/types.ts)
...
来源：[`packages/compaction/compaction/src/types.ts:37`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:57`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:63`](../packages/compaction/compaction/src/types.ts) · [`packages/core/tools/src/types.ts:22`](../packages/core/tools/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:111`](../packages/experimental/agent-team/src/types.ts) · [`packages/llm/llm/src/message.ts:137`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/types.ts:104`](../packages/llm/llm/src/types.ts)

[`packages/llm/llm/src/types.ts#ContentBlock`](#persistence-type-packagesllmllmsrctypestscontentblock) 的数组。

<a id="persistence-type-eventagentinboxspliceddatainserted0content00type"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][0].type`

SHA-256: `4e44c9118152f6829634bfd508e47669ab0497caffa380c94b4be91f9390d35d`

来源：[`packages/llm/llm/src/types.ts:391`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:55`](../packages/llm/llm/src/types.ts) · [`packages/web/web-search-deepseek/src/provider.ts:68`](../packages/web/web-search-deepseek/src/provider.ts)

`"text"`

<a id="persistence-type-eventagentinboxspliceddatainserted0content01type"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][1].type`

SHA-256: `3c2535ca0a2062f172f15344f8040755002b5ac506cf94fc4ebaa822b15feb8c`

来源：[`packages/llm/llm/src/types.ts:391`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:61`](../packages/llm/llm/src/types.ts)

`"reasoning"`

<a id="persistence-type-eventagentinboxspliceddatainserted0content02attachmentmediatype0"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][2].attachment.mediaType[0]`

SHA-256: `58f94390b982f8a5ac1f4f235ba612557f4a1dc4a995d8b1cec63ce7639decb0`

来源：[`packages/attachment/attachment/src/types.ts:15`](../packages/attachment/attachment/src/types.ts)

`"image/png"`

<a id="persistence-type-eventagentinboxspliceddatainserted0content02attachmentmediatype1"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][2].attachment.mediaType[1]`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0content02attachmentmediatype2"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][2].attachment.mediaType[2]`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0content02attachmentmediatype3"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][2].attachment.mediaType[3]`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0content02type"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][2].type`

SHA-256: `fb8b6a2e53cb9cf44c551176de0fb77d1ddc60037b99a891ff8a860b6d5c29a0`

来源：[`packages/llm/llm/src/types.ts:391`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:72`](../packages/llm/llm/src/types.ts)

`"image"`

<a id="persistence-type-eventagentinboxspliceddatainserted0content03type"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][3].type`

SHA-256: `277b61f9c6f8170425fa6ffe06cfa14376757a896a4749cb82a687d7364c4fc9`

来源：[`packages/llm/llm/src/types.ts:391`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:85`](../packages/llm/llm/src/types.ts)

`"file"`

<a id="persistence-type-eventagentinboxspliceddatainserted0content04type"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][4].type`

SHA-256: `1f0133217eeeffd8d387baf1ec8ed9856e719bcd999dc08e48624cba96d75fd7`

来源：[`packages/llm/llm/src/types.ts:391`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:92`](../packages/llm/llm/src/types.ts)

`"tool-call"`

<a id="persistence-type-eventagentinboxspliceddatainserted0content05iserror0"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][5].isError[0]`

SHA-256: `0c4205180f75b9ee1e0d878bd9a9851628b5dc18448486389d9c5fdc3f1ccda3`

来源：[`packages/core/session/src/types.ts:359`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:105`](../packages/llm/llm/src/types.ts)

`false`

<a id="persistence-type-eventagentinboxspliceddatainserted0content05type"></a>

### `event:agent/inbox/spliced.data.inserted[0].content[0][5].type`

SHA-256: `e5244812c495a80c2e78ba2c2690dca5f6b58ea8d3fe5531ff94a6f9ac5e5d66`

来源：[`packages/llm/llm/src/types.ts:102`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:391`](../packages/llm/llm/src/types.ts)

`"tool-result"`

<a id="persistence-type-eventagentinboxspliceddatainserted0role"></a>

### `event:agent/inbox/spliced.data.inserted[0].role`

SHA-256: `68f44f59e91c41395076cb77265981a601680ec8a381bbbeb6ab754ffdc94573`

来源：[`packages/api/session-controller/src/types.ts:380`](../packages/api/session-controller/src/types.ts) · [`packages/core/session/src/types.ts:189`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:75`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/message.ts:103`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:135`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:144`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:165`](../packages/llm/llm/src/message.ts) · [`packages/session/session-title/src/types.ts:37`](../packages/session/session-title/src/types.ts) · [`packages/web/web-search-deepseek/src/provider.ts:66`](../packages/web/web-search-deepseek/src/provider.ts)

`"user"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source0kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[0].kind`

SHA-256: `2765e9119edf5816ac1ab4c95c5ee32c90403f3742962eff11544f7752d59d2e`

来源：[`packages/llm/llm/src/message.ts:25`](../packages/llm/llm/src/message.ts)

`"model"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source0replaystate"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[0].replayState`

SHA-256: `bbc5696e3f13c758237b316e3cf08cda0b9fd51ffe672539883457769faa185d`

来源：[`packages/core/tools/src/types.ts:16`](../packages/core/tools/src/types.ts) · [`packages/llm/llm/src/message.ts:20`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/types.ts:370`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:379`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:415`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/llm/llm/src/message.ts:139`](../packages/llm/llm/src/message.ts)
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source11form"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[11].form`

SHA-256: `16d0507cb94b4cfc84a87446b1ba7652d6ec1d65ee1684789e747e30d542800e`

来源：[`packages/llm/llm/src/message.ts:95`](../packages/llm/llm/src/message.ts) · [`packages/subagent/subagent/src/continuation-messages.ts:18`](../packages/subagent/subagent/src/continuation-messages.ts)

`"relay"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source11kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[11].kind`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source12form"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[12].form`

SHA-256: `e8de0f457fed5b9ff94dc4950b59ef75fd8ba8af665cc7899485924a62653367`

来源：[`packages/llm/llm/src/message.ts:91`](../packages/llm/llm/src/message.ts) · [`packages/subagent/subagent/src/continuation-messages.ts:33`](../packages/subagent/subagent/src/continuation-messages.ts) · [`packages/webhook/webhook/src/types.ts:80`](../packages/webhook/webhook/src/types.ts)

`"notice"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source12kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[12].kind`

SHA-256: `bf16d2e98a7f13894ded2cffe5ce857bf473954a0e3c0ed9bc7739e2e1c7b78a`

来源：[`packages/subagent/subagent/src/continuation-messages.ts:31`](../packages/subagent/subagent/src/continuation-messages.ts)

`"subagent-settled"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source13form"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[13].form`

SHA-256: `fee1caf8ab6a65c1bc981f5a1730164490f22a2a89ffa3d0b76f1f432c44c8b5`

来源：[`packages/context/agent-instructions/src/state.ts:40`](../packages/context/agent-instructions/src/state.ts) · [`packages/llm/llm/src/message.ts:83`](../packages/llm/llm/src/message.ts) · [`packages/skill/skill/src/index.ts:151`](../packages/skill/skill/src/index.ts)

`"instructions"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source13kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[13].kind`

SHA-256: `1922cd79a70806c17758185a6ef0458bc1fb3900363906733421c16414da2509`

来源：[`packages/skill/skill/src/index.ts:147`](../packages/skill/skill/src/index.ts)

`"skill-invocation"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source14kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[14].kind`

SHA-256: `b815d7b91cdd9fc6ccc7dcba05cfc5ce1d55fab5fc0c0801803cd3630cedb602`

来源：[`packages/goal/goal/src/domain.ts:48`](../packages/goal/goal/src/domain.ts)

`"goal"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source15form"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[15].form`

SHA-256: `383cf73ae4748e5beb281ae74857ba1ffb92ae01075b9fbf51af78b666007a8f`

来源：[`packages/context/session-reference/src/types.ts:16`](../packages/context/session-reference/src/types.ts) · [`packages/llm/llm/src/message.ts:96`](../packages/llm/llm/src/message.ts)

`"recall"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source15kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[15].kind`

SHA-256: `7f13860ee89a2d35ce09f958e85a04566cd59cb1de1d73a9619a9b631961dc71`

来源：[`packages/context/session-reference/src/types.ts:14`](../packages/context/session-reference/src/types.ts)
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source15references0capturedthroughseq0"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[15].references[0].capturedThroughSeq[0]`

SHA-256: `938f7c7357bc403ea3b281a9dd016939df7a0880fc8db12612585be574d0d615`

来源：[`packages/compaction/compaction/src/types.ts:72`](../packages/compaction/compaction/src/types.ts) · [`packages/context/session-reference/src/types.ts:23`](../packages/context/session-reference/src/types.ts) · [`packages/core/session/src/types.ts:359`](../packages/core/session/src/types.ts)

`null`

<a id="persistence-type-eventagentinboxspliceddatainserted0source15version"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[15].version`

SHA-256: `f88f1b7b6bb733f685f5fb6a8744a5db9199fa53c90463ea1a33bad51153671d`

来源：[`packages/context/session-reference/src/types.ts:17`](../packages/context/session-reference/src/types.ts) · [`packages/goal/goal/src/domain.ts:26`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/domain.ts:37`](../packages/goal/goal/src/domain.ts) · [`packages/schedule/schedule/src/types.ts:73`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:80`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:87`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:94`](../packages/schedule/schedule/src/types.ts)
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source16form"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[16].form`

SHA-256: `aec150797b655c5f15ebb7a501454b0c208fbaccec9ace49d7de2171fc02f47d`

来源：[`packages/llm/llm/src/message.ts:84`](../packages/llm/llm/src/message.ts) · [`packages/skill/tool-skill/src/index.ts:36`](../packages/skill/tool-skill/src/index.ts)

`"catalog"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source16kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[16].kind`
...
来源：[`packages/context/agent-instructions/src/state.ts:45`](../packages/context/agent-instructions/src/state.ts)
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source17changes0action1"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[17].changes[0].action[1]`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source17changes0action2"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[17].changes[0].action[2]`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source17kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[17].kind`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source18kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[18].kind`
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source19kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[19].kind`

SHA-256: `db6c5246911d47a7969f6b4cb47c7d0dbbde75c402710b22ace3672fa97bebe0`

来源：[`packages/webhook/webhook/src/types.ts:75`](../packages/webhook/webhook/src/types.ts)

`"webhook"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source1kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[1].kind`
...
来源：[`packages/core/session/src/types.ts:203`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:105`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/message.ts:139`](../packages/llm/llm/src/message.ts) · [`packages/session/session-title/src/types.ts:47`](../packages/session/session-title/src/types.ts)
...
来源：[`packages/llm/llm/src/message.ts:139`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:160`](../packages/llm/llm/src/message.ts)
...
<a id="persistence-type-eventagentinboxspliceddatainserted0source3kind"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[3].kind`

SHA-256: `e654d28d1e6c471147310d2fba396d00969cfe6ed9022626d3f2c2312e0b1cbb`

来源：[`packages/llm/llm/src/message.ts:104`](../packages/llm/llm/src/message.ts)
...
| `kind` | 必需 | `"plugin"` |
| `plugin` | 必需 | `string` |
| `sections` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[6].sections`](#persistence-type-eventagentinboxspliceddatainserted0source6sections) |

<a id="persistence-type-eventagentinboxspliceddatainserted0source6form"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[6].form`

SHA-256: `6f9e00383836275e46c0a9915767f9bb561be5fc30aae490174908a93e99a912`

来源：[`packages/llm/llm/src/message.ts:86`](../packages/llm/llm/src/message.ts)

`"snapshot"`

<a id="persistence-type-eventagentinboxspliceddatainserted0source6sections"></a>

### `event:agent/inbox/spliced.data.inserted[0].source[6].sections`

SHA-256: `c748fb42c80a120038a8c587af80ec39924803c401364db11c8974d5bf6d0262`

来源：[`packages/llm/llm/src/message.ts:88`](../packages/llm/llm/src/message.ts)
...
<a id="persistence-type-eventagentinboxspliceddataoutcome"></a>

### `event:agent/inbox/spliced.data.outcome`

SHA-256: `d4e4d575abeb4b72d616dc65c17ac0eaa943cc135609395044c38d5afcb10e31`

来源：[`packages/core/agent/src/types.ts:92`](../packages/core/agent/src/types.ts)

`"canceled"`

<a id="persistence-type-eventagentinboxspliceddatatarget0"></a>

### `event:agent/inbox/spliced.data.target[0]`

SHA-256: `62ecb62dc0fe1b5e70217f8a80c39256a40ee3a1917be14e5ca899d20c35f7fd`

来源：[`packages/core/agent/src/types.ts:88`](../packages/core/agent/src/types.ts)

`"next-turn"`

<a id="persistence-type-eventagentinboxspliceddatatarget1"></a>

### `event:agent/inbox/spliced.data.target[1]`
...
<a id="persistence-type-eventagentinboxsplicedtype"></a>

### `event:agent/inbox/spliced.type`
...
<a id="persistence-type-eventapprovalaskedtype"></a>

### `event:approval/asked.type`
...
<a id="persistence-type-eventapprovaldecideddataoutcome0"></a>

### `event:approval/decided.data.outcome[0]`
...
<a id="persistence-type-eventapprovaldecideddataoutcome1"></a>

### `event:approval/decided.data.outcome[1]`

SHA-256: `2142e391b9ccb60d487afcf373ce74db98d952f69e8289eddb352a7e16e996c5`

来源：[`packages/interaction/user-approval/src/types.ts:57`](../packages/interaction/user-approval/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:32`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:38`](../packages/workflow/tool-workflow/src/types.ts)

`"cancelled"`

<a id="persistence-type-eventapprovaldecideddataoutcome2"></a>

### `event:approval/decided.data.outcome[2]`
...
<a id="persistence-type-eventapprovaldecideddataoutcome3"></a>

### `event:approval/decided.data.outcome[3]`
...
<a id="persistence-type-eventapprovaldecidedtype"></a>

### `event:approval/decided.type`
...
<a id="persistence-type-eventapprovalpolicydatapolicy0"></a>

### `event:approval/policy.data.policy[0]`
...
<a id="persistence-type-eventapprovalpolicydatapolicy1"></a>

### `event:approval/policy.data.policy[1]`
...
<a id="persistence-type-eventapprovalpolicydatasource"></a>

### `event:approval/policy.data.source`

SHA-256: `76632533f67879dcb346fcae640540dbc89b2472b0bce88c59f7e48fc5c0e668`

来源：[`packages/interaction/user-approval/src/index.ts:36`](../packages/interaction/user-approval/src/index.ts) · [`packages/sandbox/sandbox-policy/src/session-mode.ts:36`](../packages/sandbox/sandbox-policy/src/session-mode.ts)

`"delegation"`

<a id="persistence-type-eventapprovalpolicytype"></a>

### `event:approval/policy.type`
...
来源：[`packages/core/session/src/types.ts:326`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:335`](../packages/core/session/src/types.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `dt` | 必需 | [`SessionEventEnvelope[38].sourceEventSeqs`](#persistence-type-sessioneventenvelope38sourceeventseqs) |
| `index` | 必需 | `number` |
...
来源：[`packages/core/tools/src/index.ts:675`](../packages/core/tools/src/index.ts) · [`packages/core/tools/src/index.ts:677`](../packages/core/tools/src/index.ts) · [`packages/experimental/agent-team/src/types.ts:81`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:82`](../packages/experimental/agent-team/src/types.ts) · [`packages/llm/llm/src/assistant-stream.ts:26`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:33`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:42`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/call-config.ts:29`](../packages/llm/llm/src/call-config.ts)

`string` 的数组。

<a id="persistence-type-eventassistantattemptdatastream00type"></a>

### `event:assistant/attempt.data.stream[0][0].type`

SHA-256: `f9cfc89e8fe085b4fcc9cd32b74b6f103608c54d7d8cd97b47c01de34f252ba3`

来源：[`packages/llm/llm/src/assistant-stream.ts:22`](../packages/llm/llm/src/assistant-stream.ts)
...
<a id="persistence-type-eventassistantattemptdatastream01type"></a>

### `event:assistant/attempt.data.stream[0][1].type`

SHA-256: `688e853dc149f0d30b31765c12ec7e3be74169bdf1a4c6463a10b945d50cc1b8`

来源：[`packages/llm/llm/src/assistant-stream.ts:29`](../packages/llm/llm/src/assistant-stream.ts)
...
<a id="persistence-type-eventassistantattemptdatastream02type"></a>

### `event:assistant/attempt.data.stream[0][2].type`

SHA-256: `616f93a5047de668e1c30d57b1786abd76beeb4123599637ec1dc5290320ede5`

来源：[`packages/llm/llm/src/assistant-stream.ts:36`](../packages/llm/llm/src/assistant-stream.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `blockType` | 必需 | [`event:assistant/attempt.data.stream[0][3].chunk[0].blockType`](#persistence-type-eventassistantattemptdatastream03chunk0blocktype) |
| `index` | 必需 | `number` |
| `type` | 必需 | `"block-start"` |

<a id="persistence-type-eventassistantattemptdatastream03chunk0blocktype"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[0].blockType`

SHA-256: `757013fff5879d73d5753d8d1120faab56110e88ac3932485ab7e034d9e9ce61`

来源：[`packages/llm/llm/src/types.ts:391`](../packages/llm/llm/src/types.ts)
...
<a id="persistence-type-eventassistantattemptdatastream03chunk0type"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[0].type`
...
<a id="persistence-type-eventassistantattemptdatastream03chunk1type"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[1].type`

SHA-256: `5abab3a27fd2736660ecddd94b28d6bbf114986dd894880153bd1be3ccacb563`

来源：[`packages/llm/llm/src/types.ts:392`](../packages/llm/llm/src/types.ts)
...
<a id="persistence-type-eventassistantattemptdatastream03chunk2type"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[2].type`

SHA-256: `6f091fe32ab24407236090ca9d710bbaf59bb57466e9f3b8f1f6e4862bc863c6`

来源：[`packages/llm/llm/src/types.ts:393`](../packages/llm/llm/src/types.ts)
...
<a id="persistence-type-eventassistantattemptdatastream03chunk3type"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[3].type`

SHA-256: `9b4fd974c124c83743efe030ba4e1250e087505f3f74588716a521fb8d453267`

来源：[`packages/llm/llm/src/types.ts:394`](../packages/llm/llm/src/types.ts)
...
<a id="persistence-type-eventassistantattemptdatastream03chunk4type"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[4].type`

SHA-256: `eefbea819caeeea91ccb02dfafc16c68dd7f961cf9c1b2be25a2084509cf5c5a`

来源：[`packages/llm/llm/src/types.ts:395`](../packages/llm/llm/src/types.ts)
...
<a id="persistence-type-eventassistantattemptdatastream03chunk5type"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[5].type`
...
来源：[`packages/llm/llm/src/types.ts:399`](../packages/llm/llm/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `kind` | 必需 | `"stop"` |

<a id="persistence-type-eventassistantattemptdatastream03chunk6reason0kind"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[6].reason[0].kind`

SHA-256: `57f3f606ff8b6c84d9c443faace9d1dd10cca0354f37a4f515ef075f7c351b90`

来源：[`packages/llm/llm/src/types.ts:131`](../packages/llm/llm/src/types.ts)
...
<a id="persistence-type-eventassistantattemptdatastream03chunk6reason1kind"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[6].reason[1].kind`

SHA-256: `6c1cccb433ddc153facb380c7dda956237ba5c31f8a532a69142dc277890cc9b`

来源：[`packages/llm/llm/src/types.ts:132`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:285`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:399`](../packages/llm/llm/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `kind` | 必需 | `"max-tokens"` |

<a id="persistence-type-eventassistantattemptdatastream03chunk6reason2kind"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[6].reason[2].kind`

SHA-256: `68141cbe3994a5ffcd064c07c75996538437fd9dbf77ce8a2927e89ec577fabe`

来源：[`packages/core/session/src/types.ts:213`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:133`](../packages/llm/llm/src/types.ts)
...
<a id="persistence-type-eventassistantattemptdatastream03chunk6reason3kind"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[6].reason[3].kind`

SHA-256: `1e0b0b66b6f0c53fc72e52289d06b4708d776f1ca9df4c86a22bff621d403cf0`

来源：[`packages/core/session/src/types.ts:203`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:134`](../packages/llm/llm/src/types.ts)
...
<a id="persistence-type-eventassistantattemptdatastream03chunk6reason4kind"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[6].reason[4].kind`

SHA-256: `a2be0f0cb59f0d4a06557d45847d1938aced238baa77a6da416e590b8b958553`

来源：[`packages/core/session/src/types.ts:211`](../packages/core/session/src/types.ts) · [`packages/interaction/commands/src/types.ts:114`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm/src/types.ts:135`](../packages/llm/llm/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:38`](../packages/workflow/tool-workflow/src/types.ts)
...
来源：[`packages/llm/llm/src/types.ts:379`](../packages/llm/llm/src/types.ts)

`unknown` (opaque) 的数组。

<a id="persistence-type-eventassistantattemptdatastream03chunk6type"></a>

### `event:assistant/attempt.data.stream[0][3].chunk[6].type`
...
<a id="persistence-type-eventassistantattemptdatastream03type"></a>

### `event:assistant/attempt.data.stream[0][3].type`
...
<a id="persistence-type-eventassistantattempttype"></a>

### `event:assistant/attempt.type`
...
SHA-256: `a58ca1bed502d425a8b65cac02f59717498cd296de9513c6f81b83b791c20e9b`
...
<a id="persistence-type-eventassistantmessagedatamessagerole"></a>

### `event:assistant/message.data.message.role`

SHA-256: `95c0e88fcf0bafb2087f912ad9e2369de6ae6530cc0c4c2772c96205b57f7f60`

来源：[`packages/llm/llm/src/message.ts:135`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:149`](../packages/llm/llm/src/message.ts)

`"assistant"`

<a id="persistence-type-eventassistantmessagetype"></a>

### `event:assistant/message.type`
...
<a id="persistence-type-eventcommanddonedatakind1"></a>

### `event:command/done.data.kind[1]`
...
<a id="persistence-type-eventcommanddonetype"></a>

### `event:command/done.type`
...
| `commandId` | 必需 | `string` |
| `name` | 必需 | `string` |
| `source` | 必需 | [`event:agent/inbox/spliced.data.inserted[0].source[2]`](#persistence-type-eventagentinboxspliceddatainserted0source2) |

<a id="persistence-type-eventcommandruntype"></a>

### `event:command/run.type`
...
来源：[`packages/compaction/compaction/src/types.ts:24`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:72`](../packages/compaction/compaction/src/types.ts) · [`packages/context/session-reference/src/types.ts:23`](../packages/context/session-reference/src/types.ts)
...
<a id="persistence-type-eventcompactionendtype"></a>

### `event:compaction/end.type`
...
| `shadowedSeqs` | 必需 | [`SessionEventEnvelope[38].sourceEventSeqs`](#persistence-type-sessioneventenvelope38sourceeventseqs) |
...
<a id="persistence-type-eventcompactionprunetype"></a>

### `event:compaction/prune.type`
...
<a id="persistence-type-eventcompactionstarttype"></a>

### `event:compaction/start.type`
...
<a id="persistence-type-eventcompactionsummarytype"></a>

### `event:compaction/summary.type`
...
<a id="persistence-type-eventdeliverablespresentedtype"></a>

### `event:deliverables/presented.type`
...
<a id="persistence-type-eventfeedbackmessage-deletetype"></a>

### `event:feedback/message-delete.type`
...
<a id="persistence-type-eventfeedbackmessage-putdataitemcategory0"></a>

### `event:feedback/message-put.data.item.category[0]`

SHA-256: `9d80129e13edfb6feb03ed327e6085c6ef60b97ad074244b2f5fd4667424a6a4`

来源：[`packages/feedback/command-feedback/src/types.ts:31`](../packages/feedback/command-feedback/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:28`](../packages/feedback/message-feedback/src/types.ts)

`"other"`

<a id="persistence-type-eventfeedbackmessage-putdataitemcategory1"></a>

### `event:feedback/message-put.data.item.category[1]`
...
<a id="persistence-type-eventfeedbackmessage-putdataitemcategory2"></a>

### `event:feedback/message-put.data.item.category[2]`
...
<a id="persistence-type-eventfeedbackmessage-putdataitemcategory3"></a>

### `event:feedback/message-put.data.item.category[3]`
...
<a id="persistence-type-eventfeedbackmessage-putdataitemcategory4"></a>

### `event:feedback/message-put.data.item.category[4]`
...
<a id="persistence-type-eventfeedbackmessage-putdataitemcategory5"></a>

### `event:feedback/message-put.data.item.category[5]`
...
<a id="persistence-type-eventfeedbackmessage-putdataitemcategory6"></a>

### `event:feedback/message-put.data.item.category[6]`
...
<a id="persistence-type-eventfeedbackmessage-putdataitemrating0"></a>

### `event:feedback/message-put.data.item.rating[0]`

SHA-256: `df5d9709b7db2a72510dc52052a23f0c38f39730af1504bab8bccabc14fae528`

来源：[`packages/feedback/message-feedback/src/types.ts:24`](../packages/feedback/message-feedback/src/types.ts)

`"positive"`

<a id="persistence-type-eventfeedbackmessage-putdataitemrating1"></a>

### `event:feedback/message-put.data.item.rating[1]`
...
<a id="persistence-type-eventfeedbackmessage-puttype"></a>

### `event:feedback/message-put.type`
...
<a id="persistence-type-eventfeedbackrecordtype"></a>

### `event:feedback/record.type`
...
<a id="persistence-type-eventgoalchangedata0goalphase0"></a>

### `event:goal/change.data[0].goal.phase[0]`

SHA-256: `254dce209e735f9cb6f6b7aec0354712b1611759ec02af4d35a96f2081e666f6`

来源：[`packages/core/session/src/types.ts:205`](../packages/core/session/src/types.ts) · [`packages/goal/goal/src/types.ts:64`](../packages/goal/goal/src/types.ts)

`"blocked"`

<a id="persistence-type-eventgoalchangedata0goalphase1"></a>

### `event:goal/change.data[0].goal.phase[1]`

SHA-256: `d9196086e41e4dd5c2ce87f5c25529c8112a1731d258cf0728747d41a9ee3241`

来源：[`packages/goal/goal/src/domain.ts:27`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/types.ts:64`](../packages/goal/goal/src/types.ts)

`"complete"`

<a id="persistence-type-eventgoalchangedata0goalphase2"></a>

### `event:goal/change.data[0].goal.phase[2]`

SHA-256: `c8e6f48878cc2a2f0dc59682280d81f407943fb503f32c64bf9ff3d9393c3eff`

来源：[`packages/experimental/agent-team/src/types.ts:53`](../packages/experimental/agent-team/src/types.ts) · [`packages/goal/goal/src/types.ts:64`](../packages/goal/goal/src/types.ts)

`"active"`

<a id="persistence-type-eventgoalchangedata0goalphase3"></a>

### `event:goal/change.data[0].goal.phase[3]`

SHA-256: `c43b119ce579b3e9983a0d3adc4ba402ebb9ba773d89738a2dab01ecf5813943`

来源：[`packages/goal/goal/src/types.ts:64`](../packages/goal/goal/src/types.ts)

`"paused"`

<a id="persistence-type-eventgoalchangedata0kind"></a>

### `event:goal/change.data[0].kind`

SHA-256: `237c004c73b6b288246816e0d7fde16e09c63a47aa3b1227383d7afe58666163`

来源：[`packages/core/session/src/types.ts:467`](../packages/core/session/src/types.ts) · [`packages/goal/goal/src/domain.ts:25`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/domain.ts:36`](../packages/goal/goal/src/domain.ts)
...
来源：[`packages/goal/goal/src/domain.ts:27`](../packages/goal/goal/src/domain.ts)
...
<a id="persistence-type-eventgoalchangedata0operation0"></a>

### `event:goal/change.data[0].operation[0]`

SHA-256: `34d1ab5c5df378186d6054b1a1beea9a41e41965d6f336f0bc0025c441a82e66`

来源：[`packages/core/session/src/types.ts:367`](../packages/core/session/src/types.ts) · [`packages/goal/goal/src/domain.ts:27`](../packages/goal/goal/src/domain.ts)

`"resume"`

<a id="persistence-type-eventgoalchangedata0operation1"></a>

### `event:goal/change.data[0].operation[1]`
...
<a id="persistence-type-eventgoalchangedata0operation3"></a>

### `event:goal/change.data[0].operation[3]`

SHA-256: `7624ca28c61ca0eaa4f015140f3cea6e0c16cce2f2960fab5f531203d253903e`

来源：[`packages/goal/goal/src/domain.ts:27`](../packages/goal/goal/src/domain.ts) · [`packages/schedule/schedule/src/types.ts:74`](../packages/schedule/schedule/src/types.ts)

`"create"`

<a id="persistence-type-eventgoalchangedata0operation4"></a>

### `event:goal/change.data[0].operation[4]`
...
<a id="persistence-type-eventgoalchangedata0operation5"></a>

### `event:goal/change.data[0].operation[5]`
...
<a id="persistence-type-eventgoalchangedata1operation"></a>

### `event:goal/change.data[1].operation`

SHA-256: `e7e154d47d5fbc5366330fb4dade1f108c6dfe4335044d21ded14b7bf1dce084`

来源：[`packages/goal/goal/src/domain.ts:38`](../packages/goal/goal/src/domain.ts)
...
<a id="persistence-type-eventhookinvokeddatadialect0"></a>

### `event:hook/invoked.data.dialect[0]`

SHA-256: `aff60ef947c18b012644852bdd0d5bfe72065e061dd563787c76c646b4a10f6b`

来源：[`packages/hooks/hook-protocol/src/types.ts:22`](../packages/hooks/hook-protocol/src/types.ts)

`"claude-code"`

<a id="persistence-type-eventhookinvokeddatadialect1"></a>

### `event:hook/invoked.data.dialect[1]`
...
<a id="persistence-type-eventhookinvokedtype"></a>

### `event:hook/invoked.type`
...
<a id="persistence-type-eventhookresulttype"></a>

### `event:hook/result.type`
...
<a id="persistence-type-eventllmretry-startedtype"></a>

### `event:llm/retry-started.type`
...
<a id="persistence-type-eventllmretrydata0mode"></a>

### `event:llm/retry.data[0].mode`

SHA-256: `3bc287e765d58dc3a22672a0495a6cfd561220dd38fbaecef80aa95b96caed79`

来源：[`packages/llm/llm-retry/src/types.ts:22`](../packages/llm/llm-retry/src/types.ts)
...
<a id="persistence-type-eventllmretrydata1mode"></a>

### `event:llm/retry.data[1].mode`

SHA-256: `142c37d302aa22a0a57915b5255939d3ca91c1811ca13fddcf84cf76ea00758a`

来源：[`packages/llm/llm-retry/src/types.ts:35`](../packages/llm/llm-retry/src/types.ts)

`"always"`

<a id="persistence-type-eventllmretrytype"></a>

### `event:llm/retry.type`
...
<a id="persistence-type-eventmodelselectiontype"></a>

### `event:model/selection.type`
...
<a id="persistence-type-eventpermissionpresettype"></a>

### `event:permission/preset.type`
...
<a id="persistence-type-eventplanmodetype"></a>

### `event:plan/mode.type`
...
<a id="persistence-type-eventrequestcontextdatasystempromptupdate"></a>

### `event:request/context.data.systemPromptUpdate`

SHA-256: `f311671e07bc7fa645a0b6597de9966b97147956565296ba76a36543801b66c5`

来源：[`packages/core/session/src/types.ts:250`](../packages/core/session/src/types.ts)

`"in-history"`

<a id="persistence-type-eventrequestcontexttype"></a>

### `event:request/context.type`
...
来源：[`packages/llm/llm/src/types.ts:415`](../packages/llm/llm/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| [`string`] | 索引签名 | `unknown` (opaque) |

<a id="persistence-type-eventrequestheaderdatareason0"></a>

### `event:request/header.data.reason[0]`
...
<a id="persistence-type-eventrequestheaderdatareason2"></a>

### `event:request/header.data.reason[2]`
...
<a id="persistence-type-eventrequestheaderdatareason3"></a>

### `event:request/header.data.reason[3]`
...
<a id="persistence-type-eventrequestheadertype"></a>

### `event:request/header.type`
...
<a id="persistence-type-eventsandboxmodedatamode0"></a>

### `event:sandbox/mode.data.mode[0]`
...
<a id="persistence-type-eventsandboxmodedatamode1"></a>

### `event:sandbox/mode.data.mode[1]`
...
<a id="persistence-type-eventsandboxmodedatamode2"></a>

### `event:sandbox/mode.data.mode[2]`
...
<a id="persistence-type-eventsandboxmodetype"></a>

### `event:sandbox/mode.type`
...
<a id="persistence-type-eventschedulechangedata0schedule0kind"></a>

### `event:schedule/change.data[0].schedule[0].kind`

SHA-256: `5b232a9b9bfcc0fc6794dab7865bcf203a65785c5de5aa647a51228bff628413`

来源：[`packages/schedule/schedule/src/types.ts:17`](../packages/schedule/schedule/src/types.ts)

`"after"`

<a id="persistence-type-eventschedulechangedata0schedule1kind"></a>

### `event:schedule/change.data[0].schedule[1].kind`

SHA-256: `17aae616ef020b8b9f011ec398ec935450fb06d3e2a0722c456f63aeaf5ff728`

来源：[`packages/schedule/schedule/src/types.ts:31`](../packages/schedule/schedule/src/types.ts)

`"at"`

<a id="persistence-type-eventschedulechangedata0schedule2kind"></a>

### `event:schedule/change.data[0].schedule[2].kind`

SHA-256: `e42b0f40b5d0b628c6e1c44a8fb9eda0780037a81959e1b93d2dfb47b46b0e87`

来源：[`packages/schedule/schedule/src/types.ts:43`](../packages/schedule/schedule/src/types.ts)

`"every"`

<a id="persistence-type-eventschedulechangedata1operation"></a>

### `event:schedule/change.data[1].operation`
...
<a id="persistence-type-eventschedulechangedata2operation"></a>

### `event:schedule/change.data[2].operation`

SHA-256: `26c879bdd130e8b8683a6ce588414fad2244783d6573ca399fa0de184a2b0bb1`

来源：[`packages/schedule/schedule/src/types.ts:88`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:95`](../packages/schedule/schedule/src/types.ts)

`"dispatch"`

<a id="persistence-type-eventschedulechangetype"></a>

### `event:schedule/change.type`
...
<a id="persistence-type-eventsession-log-deepseekdelivery-acceptedtype"></a>

### `event:session-log-deepseek/delivery-accepted.type`
...
<a id="persistence-type-eventsessionend-seedtype"></a>

### `event:session/end-seed.type`
...
来源：[`packages/llm/llm/src/message.ts:135`](../packages/llm/llm/src/message.ts)
...
<a id="persistence-type-eventsessiontitle-llm-requestdatamessages0role1"></a>

### `event:session/title-llm-request.data.messages[0].role[1]`

SHA-256: `8af841fc9b265ade3441caf9fe40dd24db24226befba48150e6d0eeccc1389c3`

来源：[`packages/llm/llm/src/message.ts:135`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:159`](../packages/llm/llm/src/message.ts)

`"system"`

<a id="persistence-type-eventsessiontitle-llm-requesttype"></a>

### `event:session/title-llm-request.type`
...
来源：[`packages/session/session-title/src/types.ts:47`](../packages/session/session-title/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `kind` | 必需 | `"fallback"` |

<a id="persistence-type-eventsessiontitledatasource0kind"></a>

### `event:session/title.data.source[0].kind`
...
<a id="persistence-type-eventsessiontitledatasource1kind"></a>

### `event:session/title.data.source[1].kind`

SHA-256: `e31572180d6b28b73f073ad30ae19d5d82982d3daf984723984e23da1e7c459a`

来源：[`packages/session/session-title/src/types.ts:31`](../packages/session/session-title/src/types.ts)

`"provider"`

<a id="persistence-type-eventsessiontitletype"></a>

### `event:session/title.type`
...
<a id="persistence-type-eventstependtype"></a>
...
<a id="persistence-type-eventstepstarttype"></a>

### `event:step/start.type`
...
<a id="persistence-type-eventsubagentcatalogdata0mode"></a>

### `event:subagent/catalog.data[0].mode`

SHA-256: `d28765f87d6b6ab408e0b2f3e7e297791b004b806d8e302c49903ebae815feb2`

来源：[`packages/subagent/subagent/src/catalog.ts:30`](../packages/subagent/subagent/src/catalog.ts) · [`packages/subagent/subagent/src/descriptor.ts:62`](../packages/subagent/subagent/src/descriptor.ts)

`"one-shot"`

<a id="persistence-type-eventsubagentcatalogdata0version"></a>

### `event:subagent/catalog.data[0].version`

SHA-256: `93d38436347f67c9022aacbc4472e283d722bcab8eb73fc376aaf7b6a6b9fb35`

来源：[`packages/subagent/subagent/src/catalog.ts:26`](../packages/subagent/subagent/src/catalog.ts)
...
<a id="persistence-type-eventsubagentcatalogdata1mode"></a>

### `event:subagent/catalog.data[1].mode`

SHA-256: `e5d3828df1ec3e2a66879de0659e0f4866d9cfffc00825ee731a66f8a0c03d98`

来源：[`packages/subagent/subagent/src/catalog.ts:31`](../packages/subagent/subagent/src/catalog.ts) · [`packages/subagent/subagent/src/descriptor.ts:73`](../packages/subagent/subagent/src/descriptor.ts)

`"continuable"`

<a id="persistence-type-eventsubagentcatalogtype"></a>

### `event:subagent/catalog.type`
...
<a id="persistence-type-eventsubagentdescriptortype"></a>

### `event:subagent/descriptor.type`
...
<a id="persistence-type-eventsubagentmodel-selection-policytype"></a>

### `event:subagent/model-selection-policy.type`
...
SHA-256: `0ae7ccdc1cc5d9d43772ebd5c7357ff509011c3a6ba188d9c274d33df2542c42`
...
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`SessionEventEnvelope[38].sourceEventSeqs`](#persistence-type-sessioneventenvelope38sourceeventseqs) |
| `surfaceOp` | 必需 | [`packages/core/session/src/types.ts#SurfaceOp`](#persistence-type-packagescoresessionsrctypestssurfaceop) |
| `time` | 必需 | `number` |
...
SHA-256: `d489162978ec04f1f76f40a68c7715326f46ec4f696edf1f321efdf88545fc18`
...
来源：[`packages/llm/llm/src/message.ts:160`](../packages/llm/llm/src/message.ts)
...
<a id="persistence-type-eventsystemmessagetype"></a>

### `event:system/message.type`
...
来源：[`packages/experimental/agent-team/src/types.ts:52`](../packages/experimental/agent-team/src/types.ts)
...
<a id="persistence-type-eventteammemberdatamembercontext0"></a>

### `event:team/member.data.member.context[0]`
...
<a id="persistence-type-eventteammemberdatamembercontext1"></a>

### `event:team/member.data.member.context[1]`
...
<a id="persistence-type-eventteammemberdatamemberphase0"></a>

### `event:team/member.data.member.phase[0]`

SHA-256: `b57a2889408de36e4516807194c73bdecd51a92f633ccd05db81bf049200f420`

来源：[`packages/experimental/agent-team/src/types.ts:53`](../packages/experimental/agent-team/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:32`](../packages/workflow/tool-workflow/src/types.ts)

`"failed"`

<a id="persistence-type-eventteammemberdatamemberphase2"></a>

### `event:team/member.data.member.phase[2]`

SHA-256: `871bfd6f7bb91061246768d3377f3fd58d6b8ea7c31f44c714ae7ab215650d62`

来源：[`packages/experimental/agent-team/src/types.ts:53`](../packages/experimental/agent-team/src/types.ts)

`"provisioning"`

<a id="persistence-type-eventteammemberdataversion"></a>

### `event:team/member.data.version`

SHA-256: `a0f906856fc06f1c6f2083eb970e5a657a82b1a84c06c095445e5d6d161cda80`

来源：[`packages/experimental/agent-team/src/types.ts:221`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:223`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:225`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:228`](../packages/experimental/agent-team/src/types.ts)

`2`

<a id="persistence-type-eventteammembertype"></a>
...
<a id="persistence-type-eventteammessagedeliveredtype"></a>

### `event:team/message/delivered.type`
...
<a id="persistence-type-eventteammessagequeuedtype"></a>

### `event:team/message/queued.type`
...
<a id="persistence-type-eventteamtaskdatataskstatus0"></a>

### `event:team/task.data.task.status[0]`

SHA-256: `1ebc6f9ff3aa9e3a38f8695f49bacdab1f8b7a3832741853ca46f40af56ccd01`

来源：[`packages/core/session/src/types.ts:201`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:79`](../packages/experimental/agent-team/src/types.ts) · [`packages/todo/tool-todo/src/types.ts:25`](../packages/todo/tool-todo/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:32`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:38`](../packages/workflow/tool-workflow/src/types.ts)

`"completed"`

<a id="persistence-type-eventteamtaskdatataskstatus1"></a>

### `event:team/task.data.task.status[1]`

SHA-256: `234142ee4f996f38cc9fa3b8b3e3de29b03c9aefe5ebf6c224eddd564505aa85`

来源：[`packages/experimental/agent-team/src/types.ts:79`](../packages/experimental/agent-team/src/types.ts) · [`packages/todo/tool-todo/src/types.ts:25`](../packages/todo/tool-todo/src/types.ts)

`"pending"`

<a id="persistence-type-eventteamtaskdatataskstatus2"></a>

### `event:team/task.data.task.status[2]`
...
<a id="persistence-type-eventteamtaskdatataskstatus3"></a>

### `event:team/task.data.task.status[3]`

SHA-256: `e7e8f1318170b8284f16ab45a557afd4675c96071c0f2a456636481dab20b427`

来源：[`packages/experimental/agent-team/src/types.ts:79`](../packages/experimental/agent-team/src/types.ts)

`"deleted"`

<a id="persistence-type-eventteamtasktype"></a>

### `event:team/task.type`
...
来源：[`packages/todo/tool-todo/src/types.ts:25`](../packages/todo/tool-todo/src/types.ts)
...
<a id="persistence-type-eventtodowritetype"></a>

### `event:todo/write.type`
...
<a id="persistence-type-eventtool-workflowagent-endtype"></a>

### `event:tool-workflow/agent-end.type`
...
<a id="persistence-type-eventtool-workflowagent-starttype"></a>

### `event:tool-workflow/agent-start.type`
...
<a id="persistence-type-eventtool-workflowrun-endtype"></a>

### `event:tool-workflow/run-end.type`
...
<a id="persistence-type-eventtool-workflowrun-starttype"></a>

### `event:tool-workflow/run-start.type`
...
<a id="persistence-type-eventtoolcalltype"></a>

### `event:tool/call.type`
...
<a id="persistence-type-eventtoolptc-dispatch-starttype"></a>

### `event:tool/ptc-dispatch-start.type`
...
<a id="persistence-type-eventtoolptc-dispatchtype"></a>

### `event:tool/ptc-dispatch.type`
...
来源：[`packages/llm/llm/src/message.ts:166`](../packages/llm/llm/src/message.ts)
...
<a id="persistence-type-eventtoolresulttype"></a>

### `event:tool/result.type`
...
<a id="persistence-type-eventturnenddatareason1reason1kind"></a>

### `event:turn/end.data.reason[1].reason[1].kind`
...
<a id="persistence-type-eventturnenddatareason1reason2kind"></a>

### `event:turn/end.data.reason[1].reason[2].kind`
...
<a id="persistence-type-eventturnenddatareason1reason3kind"></a>

### `event:turn/end.data.reason[1].reason[3].kind`
...
<a id="persistence-type-eventturnenddatareason1reason4kind"></a>

### `event:turn/end.data.reason[1].reason[4].kind`
...
<a id="persistence-type-eventturnenddatareason5kind"></a>

### `event:turn/end.data.reason[5].kind`
...
<a id="persistence-type-eventturnendtype"></a>
...
<a id="persistence-type-eventturnstarttype"></a>

### `event:turn/start.type`
...
SHA-256: `2e49ede7fb3a592cce8919ebe982f6ca1c1f67abe4def359ffc028c85e6d1ad8`
...
<a id="persistence-type-eventusermessagetype"></a>

### `event:user/message.type`
...
来源：[`packages/web/web-search-deepseek/src/provider.ts:67`](../packages/web/web-search-deepseek/src/provider.ts)
...
来源：[`packages/llm/llm/src/message.ts:137`](../packages/llm/llm/src/message.ts) · [`packages/web/web-search-deepseek/src/provider.ts:67`](../packages/web/web-search-deepseek/src/provider.ts)
...
<a id="persistence-type-eventwebdeepseek-search-llm-requestdatabodytools0name"></a>

### `event:web/deepseek-search-llm-request.data.body.tools[0].name`

SHA-256: `935c8d486292b13c87b57ca280eb8c58b5b2f5239be86fcd4334c33fdeb87682`

来源：[`packages/web/web-search-deepseek/src/provider.ts:74`](../packages/web/web-search-deepseek/src/provider.ts)

`"web_search"`

<a id="persistence-type-eventwebdeepseek-search-llm-requestdatabodytools0type"></a>

### `event:web/deepseek-search-llm-request.data.body.tools[0].type`
...
<a id="persistence-type-eventwebdeepseek-search-llm-requesttype"></a>

### `event:web/deepseek-search-llm-request.type`
...
<a id="persistence-type-jsonlheaderlineagentpreset"></a>

### `JsonlHeaderLine.agentPreset`

SHA-256: `4cd48f3e5108bd6ebedf7301c3638839b8b2b9db8dbd493974177fbdeb91a01b`

来源：[`packages/api/session-controller/src/types.ts:380`](../packages/api/session-controller/src/types.ts) · [`packages/api/session-controller/src/types.ts:87`](../packages/api/session-controller/src/types.ts) · [`packages/api/session-controller/src/types.ts:88`](../packages/api/session-controller/src/types.ts) · [`packages/api/session-controller/src/types.ts:89`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/types.ts:13`](../packages/attachment/attachment/src/types.ts) · [`packages/attachment/attachment/src/types.ts:23`](../packages/attachment/attachment/src/types.ts) · [`packages/attachment/attachment/src/types.ts:41`](../packages/attachment/attachment/src/types.ts) · [`packages/attachment/attachment/src/types.ts:43`](../packages/attachment/attachment/src/types.ts) · [`packages/compaction/compaction/src/types.ts:24`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:35`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:36`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:42`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:49`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:72`](../packages/compaction/compaction/src/types.ts) · [`packages/context/agent-instructions/src/render.ts:49`](../packages/context/agent-instructions/src/render.ts) · [`packages/context/agent-instructions/src/render.ts:50`](../packages/context/agent-instructions/src/render.ts) · [`packages/context/agent-instructions/src/render.ts:51`](../packages/context/agent-instructions/src/render.ts) · [`packages/context/agent-instructions/src/state.ts:44`](../packages/context/agent-instructions/src/state.ts) · [`packages/context/session-reference/src/types.ts:19`](../packages/context/session-reference/src/types.ts) · [`packages/context/session-reference/src/types.ts:20`](../packages/context/session-reference/src/types.ts) · [`packages/core/session/src/types.ts:100`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:104`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:106`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:129`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:191`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:244`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:246`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:341`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:358`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:359`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:12`](../packages/core/tools/src/types.ts) · [`packages/core/tools/src/types.ts:13`](../packages/core/tools/src/types.ts) · [`packages/core/tools/src/types.ts:14`](../packages/core/tools/src/types.ts) · [`packages/core/tools/src/types.ts:15`](../packages/core/tools/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:107`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:108`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:109`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:110`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:117`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:118`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:119`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:120`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:221`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:223`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:225`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:229`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:230`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:231`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:48`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:49`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:50`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:51`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:54`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:75`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:77`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:78`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:80`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:81`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/command-feedback/src/types.ts:29`](../packages/feedback/command-feedback/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:22`](../packages/feedback/message-feedback/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:26`](../packages/feedback/message-feedback/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:30`](../packages/feedback/message-feedback/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:40`](../packages/feedback/message-feedback/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:48`](../packages/feedback/message-feedback/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:50`](../packages/feedback/message-feedback/src/types.ts) · [`packages/fs/tool-present/src/types.ts:15`](../packages/fs/tool-present/src/types.ts) · [`packages/fs/tool-present/src/types.ts:7`](../packages/fs/tool-present/src/types.ts) · [`packages/fs/tool-present/src/types.ts:9`](../packages/fs/tool-present/src/types.ts) · [`packages/goal/goal/src/domain.ts:49`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/types.ts:22`](../packages/goal/goal/src/types.ts) · [`packages/goal/goal/src/types.ts:54`](../packages/goal/goal/src/types.ts) · [`packages/goal/goal/src/types.ts:56`](../packages/goal/goal/src/types.ts) · [`packages/goal/goal/src/types.ts:62`](../packages/goal/goal/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:21`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:23`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:24`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:33`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:34`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:35`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:37`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/interaction/commands/src/types.ts:105`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/commands/src/types.ts:113`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/commands/src/types.ts:115`](../packages/interaction/commands/src/types.ts) · [`packages/interaction/permission-presets/src/index.ts:54`](../packages/interaction/permission-presets/src/index.ts) · [`packages/interaction/user-approval/src/types.ts:45`](../packages/interaction/user-approval/src/types.ts) · [`packages/interaction/user-approval/src/types.ts:46`](../packages/interaction/user-approval/src/types.ts) · [`packages/interaction/user-approval/src/types.ts:47`](../packages/interaction/user-approval/src/types.ts) · [`packages/interaction/user-approval/src/types.ts:48`](../packages/interaction/user-approval/src/types.ts) · [`packages/interaction/user-approval/src/types.ts:56`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:18`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:21`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:23`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:31`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:34`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:36`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:44`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm/src/assistant-stream.ts:26`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:40`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:41`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/call-config.ts:24`](../packages/llm/llm/src/call-config.ts) · [`packages/llm/llm/src/call-config.ts:25`](../packages/llm/llm/src/call-config.ts) · [`packages/llm/llm/src/call-config.ts:26`](../packages/llm/llm/src/call-config.ts) · [`packages/llm/llm/src/call-config.ts:29`](../packages/llm/llm/src/call-config.ts) · [`packages/llm/llm/src/message.ts:104`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:12`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:133`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:14`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:31`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:67`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:69`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:93`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/types.ts:103`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:392`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:393`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:394`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:412`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:413`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:415`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:42`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:44`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:50`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:56`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:62`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:94`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:95`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:97`](../packages/llm/llm/src/types.ts) · [`packages/preset/agent-presets/src/session.ts:28`](../packages/preset/agent-presets/src/session.ts) · [`packages/schedule/schedule/src/types.ts:15`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:19`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:23`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:29`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:33`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:35`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:41`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:45`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:49`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:82`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:89`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:96`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:98`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-log-deepseek/src/types.ts:83`](../packages/session/session-log-deepseek/src/types.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:85`](../packages/session/session-persistence-jsonl/src/format.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:87`](../packages/session/session-persistence-jsonl/src/format.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:88`](../packages/session/session-persistence-jsonl/src/format.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:92`](../packages/session/session-persistence-jsonl/src/format.ts) · [`packages/session/session-title-llm/src/index.ts:29`](../packages/session/session-title-llm/src/index.ts) · [`packages/session/session-title-llm/src/index.ts:35`](../packages/session/session-title-llm/src/index.ts) · [`packages/session/session-title/src/types.ts:22`](../packages/session/session-title/src/types.ts) · [`packages/session/session-title/src/types.ts:24`](../packages/session/session-title/src/types.ts) · [`packages/session/session-title/src/types.ts:32`](../packages/session/session-title/src/types.ts) · [`packages/session/session-title/src/types.ts:43`](../packages/session/session-title/src/types.ts) · [`packages/skill/skill/src/index.ts:149`](../packages/skill/skill/src/index.ts) · [`packages/skill/tool-skill/src/index.ts:40`](../packages/skill/tool-skill/src/index.ts) · [`packages/subagent/subagent/src/catalog.ts:27`](../packages/subagent/subagent/src/catalog.ts) · [`packages/subagent/subagent/src/catalog.ts:30`](../packages/subagent/subagent/src/catalog.ts) · [`packages/subagent/subagent/src/catalog.ts:31`](../packages/subagent/subagent/src/catalog.ts) · [`packages/subagent/subagent/src/continuation-messages.ts:20`](../packages/subagent/subagent/src/continuation-messages.ts) · [`packages/subagent/subagent/src/continuation-messages.ts:35`](../packages/subagent/subagent/src/continuation-messages.ts) · [`packages/subagent/subagent/src/continuation-messages.ts:37`](../packages/subagent/subagent/src/continuation-messages.ts) · [`packages/subagent/subagent/src/descriptor.ts:57`](../packages/subagent/subagent/src/descriptor.ts) · [`packages/subagent/subagent/src/descriptor.ts:68`](../packages/subagent/subagent/src/descriptor.ts) · [`packages/subagent/subagent/src/descriptor.ts:75`](../packages/subagent/subagent/src/descriptor.ts) · [`packages/subagent/subagent/src/descriptor.ts:77`](../packages/subagent/subagent/src/descriptor.ts) · [`packages/subagent/subagent/src/descriptor.ts:79`](../packages/subagent/subagent/src/descriptor.ts) · [`packages/subagent/subagent/src/descriptor.ts:81`](../packages/subagent/subagent/src/descriptor.ts) · [`packages/subagent/subagent/src/descriptor.ts:83`](../packages/subagent/subagent/src/descriptor.ts) · [`packages/subagent/tool-subagent/src/model-selection.ts:11`](../packages/subagent/tool-subagent/src/model-selection.ts) · [`packages/subagent/tool-subagent/src/model-selection.ts:13`](../packages/subagent/tool-subagent/src/model-selection.ts) · [`packages/todo/tool-todo/src/types.ts:23`](../packages/todo/tool-todo/src/types.ts) · [`packages/web/web-search-deepseek/src/provider.ts:58`](../packages/web/web-search-deepseek/src/provider.ts) · [`packages/web/web-search-deepseek/src/provider.ts:60`](../packages/web/web-search-deepseek/src/provider.ts) · [`packages/web/web-search-deepseek/src/provider.ts:63`](../packages/web/web-search-deepseek/src/provider.ts) · [`packages/web/web-search-deepseek/src/provider.ts:69`](../packages/web/web-search-deepseek/src/provider.ts) · [`packages/webhook/webhook/src/types.ts:76`](../packages/webhook/webhook/src/types.ts) · [`packages/webhook/webhook/src/types.ts:77`](../packages/webhook/webhook/src/types.ts) · [`packages/webhook/webhook/src/types.ts:78`](../packages/webhook/webhook/src/types.ts) · [`packages/webhook/webhook/src/types.ts:79`](../packages/webhook/webhook/src/types.ts) · [`packages/webhook/webhook/src/types.ts:81`](../packages/webhook/webhook/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:15`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:16`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:21`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:23`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:24`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:25`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:30`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:37`](../packages/workflow/tool-workflow/src/types.ts)

`string`

<a id="persistence-type-jsonlheaderlinecreatedat"></a>

### `JsonlHeaderLine.createdAt`

SHA-256: `0657d3ca5ac4e7bf79b00bcf860b1c7159d01a9da137497221ec2f1776e365f7`

来源：[`packages/attachment/attachment/src/types.ts:17`](../packages/attachment/attachment/src/types.ts) · [`packages/attachment/attachment/src/types.ts:19`](../packages/attachment/attachment/src/types.ts) · [`packages/attachment/attachment/src/types.ts:21`](../packages/attachment/attachment/src/types.ts) · [`packages/attachment/attachment/src/types.ts:29`](../packages/attachment/attachment/src/types.ts) · [`packages/attachment/attachment/src/types.ts:30`](../packages/attachment/attachment/src/types.ts) · [`packages/attachment/attachment/src/types.ts:45`](../packages/attachment/attachment/src/types.ts) · [`packages/compaction/compaction/src/types.ts:38`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:40`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:51`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:72`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:84`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:86`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:88`](../packages/compaction/compaction/src/types.ts) · [`packages/context/session-reference/src/types.ts:22`](../packages/context/session-reference/src/types.ts) · [`packages/context/session-reference/src/types.ts:23`](../packages/context/session-reference/src/types.ts) · [`packages/context/session-reference/src/types.ts:25`](../packages/context/session-reference/src/types.ts) · [`packages/context/session-reference/src/types.ts:26`](../packages/context/session-reference/src/types.ts) · [`packages/context/session-reference/src/types.ts:27`](../packages/context/session-reference/src/types.ts) · [`packages/context/session-reference/src/types.ts:28`](../packages/context/session-reference/src/types.ts) · [`packages/context/session-reference/src/types.ts:30`](../packages/context/session-reference/src/types.ts) · [`packages/core/agent/src/types.ts:89`](../packages/core/agent/src/types.ts) · [`packages/core/agent/src/types.ts:90`](../packages/core/agent/src/types.ts) · [`packages/core/session/src/types.ts:102`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:122`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:248`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:276`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:285`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:287`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:289`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:310`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:322`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:323`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:335`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:341`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:354`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:355`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:359`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:436`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:469`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:471`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:76`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:32`](../packages/feedback/message-feedback/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:34`](../packages/feedback/message-feedback/src/types.ts) · [`packages/fs/tool-present/src/types.ts:15`](../packages/fs/tool-present/src/types.ts) · [`packages/goal/goal/src/domain.ts:29`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/domain.ts:30`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/domain.ts:31`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/domain.ts:40`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/domain.ts:50`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/domain.ts:52`](../packages/goal/goal/src/domain.ts) · [`packages/goal/goal/src/types.ts:24`](../packages/goal/goal/src/types.ts) · [`packages/goal/goal/src/types.ts:68`](../packages/goal/goal/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:20`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:32`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:36`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/hooks/hook-protocol/src/types.ts:38`](../packages/hooks/hook-protocol/src/types.ts) · [`packages/interaction/commands/src/types.ts:116`](../packages/interaction/commands/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:19`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:20`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:24`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:25`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:26`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:32`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:33`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:37`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:38`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:45`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:46`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:47`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm/src/assistant-stream.ts:23`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:24`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:25`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:30`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:31`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:37`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:38`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:44`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/call-config.ts:27`](../packages/llm/llm/src/call-config.ts) · [`packages/llm/llm/src/call-config.ts:28`](../packages/llm/llm/src/call-config.ts) · [`packages/llm/llm/src/types.ts:150`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:151`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:159`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:160`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:161`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:162`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:391`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:392`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:393`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:394`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:395`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:46`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:48`](../packages/llm/llm/src/types.ts) · [`packages/schedule/schedule/src/types.ts:21`](../packages/schedule/schedule/src/types.ts) · [`packages/schedule/schedule/src/types.ts:47`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-log-deepseek/src/types.ts:85`](../packages/session/session-log-deepseek/src/types.ts) · [`packages/session/session-log-deepseek/src/types.ts:87`](../packages/session/session-log-deepseek/src/types.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:84`](../packages/session/session-persistence-jsonl/src/format.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:86`](../packages/session/session-persistence-jsonl/src/format.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:91`](../packages/session/session-persistence-jsonl/src/format.ts) · [`packages/session/session-title-llm/src/index.ts:39`](../packages/session/session-title-llm/src/index.ts) · [`packages/subagent/subagent/src/catalog.ts:28`](../packages/subagent/subagent/src/catalog.ts) · [`packages/subagent/subagent/src/descriptor.ts:53`](../packages/subagent/subagent/src/descriptor.ts) · [`packages/web/web-search-deepseek/src/provider.ts:64`](../packages/web/web-search-deepseek/src/provider.ts) · [`packages/web/web-search-deepseek/src/provider.ts:75`](../packages/web/web-search-deepseek/src/provider.ts) · [`packages/workflow/tool-workflow/src/types.ts:22`](../packages/workflow/tool-workflow/src/types.ts) · [`packages/workflow/tool-workflow/src/types.ts:31`](../packages/workflow/tool-workflow/src/types.ts)

`number`

<a id="persistence-type-jsonlheaderlineisseeded"></a>

### `JsonlHeaderLine.isSeeded`

SHA-256: `aa93010d0e521ad7c42273f58d5c9b8bf1dfc94edf1b805a3971b364a35c1877`

来源：[`packages/context/session-reference/src/types.ts:24`](../packages/context/session-reference/src/types.ts) · [`packages/context/session-reference/src/types.ts:29`](../packages/context/session-reference/src/types.ts) · [`packages/core/session/src/types.ts:111`](../packages/core/session/src/types.ts) · [`packages/core/tools/src/types.ts:21`](../packages/core/tools/src/types.ts) · [`packages/plan/plan-mode/src/index.ts:47`](../packages/plan/plan-mode/src/index.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:89`](../packages/session/session-persistence-jsonl/src/format.ts)
...
来源：[`packages/core/session/src/types.ts:116`](../packages/core/session/src/types.ts) · [`packages/session/session-persistence-jsonl/src/format.ts:90`](../packages/session/session-persistence-jsonl/src/format.ts)

`"subagent"`

<a id="persistence-type-jsonlheaderlinetype"></a>

### `JsonlHeaderLine.type`
...
来源：[`packages/llm/llm/src/types.ts:87`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/llm/llm/src/types.ts:74`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/subagent/subagent/src/descriptor.ts:85`](../packages/subagent/subagent/src/descriptor.ts)
...
来源：[`packages/feedback/message-feedback/src/types.ts:42`](../packages/feedback/message-feedback/src/types.ts)
...
来源：[`packages/goal/goal/src/types.ts:66`](../packages/goal/goal/src/types.ts)
...
来源：[`packages/goal/goal/src/domain.ts:39`](../packages/goal/goal/src/domain.ts)
...
来源：[`packages/goal/goal/src/domain.ts:28`](../packages/goal/goal/src/domain.ts)
...
来源：[`packages/llm/llm/src/message.ts:139`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:150`](../packages/llm/llm/src/message.ts)
...
来源：[`packages/llm/llm/src/message.ts:139`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:167`](../packages/llm/llm/src/message.ts)
...
来源：[`packages/core/agent/src/types.ts:91`](../packages/core/agent/src/types.ts) · [`packages/core/session/src/types.ts:472`](../packages/core/session/src/types.ts)
...
来源：[`packages/llm/llm/src/message.ts:137`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/types.ts:395`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/core/session/src/types.ts:211`](../packages/core/session/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:27`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm-retry/src/types.ts:39`](../packages/llm/llm-retry/src/types.ts) · [`packages/llm/llm/src/types.ts:134`](../packages/llm/llm/src/types.ts) · [`packages/llm/llm/src/types.ts:135`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/llm/llm/src/types.ts:401`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/compaction/compaction/src/types.ts:53`](../packages/compaction/compaction/src/types.ts) · [`packages/core/session/src/types.ts:327`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/types.ts:396`](../packages/llm/llm/src/types.ts)
...
来源：[`packages/llm/llm/src/message.ts:137`](../packages/llm/llm/src/message.ts) · [`packages/llm/llm/src/message.ts:166`](../packages/llm/llm/src/message.ts)
...
来源：[`packages/schedule/schedule/src/types.ts:75`](../packages/schedule/schedule/src/types.ts)
...
来源：[`packages/session/session-title-llm/src/index.ts:33`](../packages/session/session-title-llm/src/index.ts) · [`packages/session/session-title/src/types.ts:33`](../packages/session/session-title/src/types.ts) · [`packages/subagent/tool-subagent/src/model-selection-state.ts:19`](../packages/subagent/tool-subagent/src/model-selection-state.ts)
...
来源：[`packages/workflow/tool-workflow/src/types.ts:32`](../packages/workflow/tool-workflow/src/types.ts)
...
- [`SessionEventEnvelope[38]`](#persistence-type-sessioneventenvelope38)
...
<a id="persistence-type-sessioneventenvelope0ignorable"></a>

### `SessionEventEnvelope[0].ignorable`

SHA-256: `dacf3d5f3e4ff619c1320e64a48dec5e7ecd7870bece65fbd449a0e63adfa521`

来源：[`packages/compaction/compaction/src/types.ts:59`](../packages/compaction/compaction/src/types.ts) · [`packages/context/agent-instructions/src/state.ts:42`](../packages/context/agent-instructions/src/state.ts) · [`packages/core/session/src/types.ts:328`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:359`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:369`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:400`](../packages/core/session/src/types.ts) · [`packages/core/session/src/types.ts:483`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/call-config.ts:37`](../packages/llm/llm/src/call-config.ts) · [`packages/llm/llm/src/call-config.ts:38`](../packages/llm/llm/src/call-config.ts) · [`packages/llm/llm/src/types.ts:105`](../packages/llm/llm/src/types.ts) · [`packages/skill/tool-skill/src/index.ts:38`](../packages/skill/tool-skill/src/index.ts)

`true`

<a id="persistence-type-sessioneventenvelope38"></a>

### `SessionEventEnvelope[38]`
...
<a id="persistence-type-sessioneventenvelope38sourceeventseqs"></a>

### `SessionEventEnvelope[38].sourceEventSeqs`

SHA-256: `5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78`

来源：[`packages/compaction/compaction/src/types.ts:39`](../packages/compaction/compaction/src/types.ts) · [`packages/compaction/compaction/src/types.ts:86`](../packages/compaction/compaction/src/types.ts) · [`packages/core/session/src/types.ts:449`](../packages/core/session/src/types.ts) · [`packages/llm/llm/src/assistant-stream.ts:25`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:32`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/llm/llm/src/assistant-stream.ts:39`](../packages/llm/llm/src/assistant-stream.ts) · [`packages/session/session-title-llm/src/index.ts:31`](../packages/session/session-title-llm/src/index.ts) · [`packages/session/session-title/src/types.ts:45`](../packages/session/session-title/src/types.ts)
...
<a id="persistence-type-sessioneventenvelope6surfaceop0"></a>

### `SessionEventEnvelope[6].surfaceOp[0]`
...
<a id="persistence-type-sessioneventenvelope6surfaceop1op"></a>

### `SessionEventEnvelope[6].surfaceOp[1].op`

SHA-256: `f6cb462f808309e315fea634f1ed86268b8346bbcee6774d9097ca6eed7ac1f8`

来源：[`packages/context/agent-instructions/src/render.ts:48`](../packages/context/agent-instructions/src/render.ts) · [`packages/core/session/src/types.ts:436`](../packages/core/session/src/types.ts)

`"replace"`

<a id="persistence-type-sessionheaderversion"></a>

### `SessionHeader.version`

SHA-256: `137ac60e26bcb192210d9a32a704b73b0924ed34019323defa1b787be95bd45e`

来源：[`packages/core/session/src/types.ts:98`](../packages/core/session/src/types.ts)
