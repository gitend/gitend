...
The envelope removes ignorable, request/header gains optional startsSeries and the series reason, and model-selection, subagent model-policy, and delivery-acceptance events are added. Session SQLite schema advances from 17 to 19, replacing the ignorable row field with is_packed. The writer format remains 0 despite these structural changes.
...
| Item | Recorded value |
|---|---|
| Source commit | [bc954280ae67e349291e51e5787c6987e767fa40](https://github.com/deepseek-harness/deepseek-harness/tree/bc954280ae67e349291e51e5787c6987e767fa40) |
| Commit date | 2026-08-27T16:57:43.000Z |
| Release page | [dsh-v0.1.2-alpha.1](https://github.com/deepseek-harness/deepseek-harness/releases/tag/dsh-v0.1.2-alpha.1) |
| Previous release | [dsh-v0.1.1-rc.2](dsh-v0.1.1-rc.2.md) · [source comparison](https://github.com/deepseek-harness/deepseek-harness/compare/29b22c53218d503f45169427fec445220db8ee1e...bc954280ae67e349291e51e5787c6987e767fa40) |
...
Detected 52 changed roots and 61 structural differences. The minimum below is calculated using current rules for comparison only; it does not assert historical compliance, migration correctness, or runtime compatibility.
