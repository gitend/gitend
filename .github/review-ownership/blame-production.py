...
EXTENSIONS = frozenset(('.ts', '.tsx', '.js', '.jsx', '.mjs', '.cjs', '.css', '.scss', '.py', '.c', '.h', '.cpp', '.hpp', '.rs'))
...
def production_path(path):
    ...
    return (
        name.parts[0] in ('packages', 'apps', 'python', 'native')
        and 'src' in name.parts
    ...
    ) or path == 'python/sdk-runtime/runtime-bootstrap.mjs'
