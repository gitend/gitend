...
import {
  ...
  type ComposedStack, type Profile, type probePackage,
...
describe('PluginManager', () => {
  ...
  describe('list', () => {
    ...
    it('lists a plugin module\'s main export as "." ahead of its declared modules, unless it declares "." itself', async () => {
      const staged = await stageHome()
