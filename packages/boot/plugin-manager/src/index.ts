 ...
 * in the profile directory, reads static package declarations, and rejects
 * conflicting bundle layers while retaining undeclared packages. It needs the profile on disk, not
