...
export const zh = {
  ...
  'access.autoLabel': 'Auto review',
  'access.autoDescription': '无沙箱运行；每次工具调用前由同一模型进行实验性审查。',
  'access.experimentalBadge': 'EXP',
  'access.autoConfirm.title': '确认启用 Auto review（实验）？',
  'access.autoConfirm.description': 'Auto review 不使用沙箱。每次工具调用前，都会由与当前 agent 相同的模型进行审查。此功能仍属实验性，可能误放行或误拒绝，并会消耗额外 token。',
  'access.autoConfirm.acknowledge': '我已了解这些风险，并愿意继续',
  'access.autoConfirm.enable': '启用 Auto review',
...
export const en = {
  ...
  'access.autoLabel': 'Auto review',
  'access.autoDescription': 'Run without a sandbox after an experimental same-model review of every tool call.',
  'access.experimentalBadge': 'EXP',
  'access.autoConfirm.title': 'Enable Auto review (experimental)?',
  'access.autoConfirm.description': 'Auto review runs without a sandbox. Before every tool call, the same model as the current agent reviews whether to allow it. This feature is experimental, can falsely allow or deny actions, and uses additional tokens.',
  'access.autoConfirm.acknowledge': 'I understand these risks and want to continue',
  'access.autoConfirm.enable': 'Enable Auto review',
