...
import { DUNDER_MEMBER, PORTABLE_RESERVED_WORDS, RESERVED_BINDING_GLOBALS, RESERVED_ERROR_MEMBERS } from '@deepseek-ai/dsh-code-runtime'
 ...
 */
export function validateBindings(request: CodeRunRequest): Map<string, CodeBindingNamespace> {
